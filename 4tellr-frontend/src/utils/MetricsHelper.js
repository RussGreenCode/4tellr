...
export const generateBarData = (filteredMetrics) => {
  return [
    ...
    { name: 'Missed EXP', value: filteredMetrics.eventStatus.MEETS_SLO, color: 'lightgreen', eventType: 'MEETS_SLO' },
    { name: 'On Time', value: filteredMetrics.eventStatus.ON_TIME, color: 'darkgreen', eventType: 'ON_TIME' },
